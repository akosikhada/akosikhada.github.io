...
export const projects = [
  {
    ...
    tags: [
      ...
      { name: "Zustand", icon: "/assets/icons/zustand.png" },
      { name: "Shadcn UI", icon: "/assets/icons/shadcn.png" },
      ...
      { name: "Socket IO", icon: "/assets/icons/socket.png" },
      { name: "Clerk", icon: "/assets/icons/clerk.png" },
  ...
  },
  {
    ...
    tags: [
      ...
      { name: "CoinGecko", icon: "/assets/icons/coingecko.png" },
    ],
    source: "",
  ...
  },
  {
    ...
    tags: [
      ...
      { name: "Framer Motion", icon: "/assets/icons/framer.png" },
      { name: "Git", icon: "/assets/icons/git.png" },
      { name: "Github", icon: "/assets/icons/github.png" },
      { name: "Visual Studio Code", icon: "/assets/icons/vscode.png" },
